...
//	        List<Professeur> professeurFromDb = matiere.getProfesseurs(); // Récupérer les professeurs associés à la matière
//	        for (Professeur p : professeurFromDb) {
//	            Professeur pro = professeurRepository.findById(p.getId_Professeur()).orElse(null);
//	            if (pro != null) {
//	                professeurs.add(pro);
//	            }
//	        }
