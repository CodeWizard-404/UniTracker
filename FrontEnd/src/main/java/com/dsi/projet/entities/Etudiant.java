...
public class Etudiant {
	...
	public Etudiant(String nom_Etd, String prenom_Etd, String email_Etd, String adresse_Etd, boolean redoublant,
			LocalDate date_de_naissance_Etd, String sexe_Etd, String telephone_Etd, String mot_de_passe_Etd,
			String cin_Etd) {
		super();
